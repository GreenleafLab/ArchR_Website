...
Similarly, `getGroupFragments()` provides a shortcut to doing fragment export based on cell groupings defined in `cellColData`. However, this function creats fragment files on disk, rather than storing them as a `GRanges` object.
