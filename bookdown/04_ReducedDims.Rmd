...
#JJJ would be nice to see an example of what these batch effects look like and how this corrects them
```
...
For the purposes of this tutorial, we will compute the iterative LSI for the `ArchRProject` that still contains doublets (`projHeme1`).
...
```{r include=FALSE, eval=FALSE, echo=FALSE}
#JJJ should add an example of estimated LSI here
```
