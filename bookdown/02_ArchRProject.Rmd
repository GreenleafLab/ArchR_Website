...
```{r eval=FALSE}
plotPDF(p1,p2,p3,p4, name = "QC-Sample-Statistics.pdf", ArchRProj = projHeme, addDOC = FALSE, width = 4, height = 4)
```
...
```{r eval=FALSE}
plotPDF(p1,p2, name = "QC-Sample-FragSizes-TSSProfile.pdf", ArchRProj = projHeme, addDOC = FALSE, width = 5, height = 5)
```
